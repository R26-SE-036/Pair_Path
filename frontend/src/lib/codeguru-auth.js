 ...
 *
 * If you need to change how PairPath talks to Code Coach's auth API, change
 * it THERE and copy the file here again. Editing this copy makes the three
 * services drift apart, and the field-name mismatches that follow (identifier
 * vs email, full_name vs fullName) are exactly what this file exists to
 * prevent.
 *
 * It stays a .js file so it can remain identical to the master; the project
 * has allowJs enabled.
 * =====================================================================
 *
