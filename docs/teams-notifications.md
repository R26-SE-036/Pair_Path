...
the "Incoming Webhook" you may find in older tutorials — between 18 and 22 May
2026. Any guide telling you to add an Incoming Webhook connector is out of date.
...
*Notify Teams* run appears, and a message should land in the channel.
...
2. Trigger: **When a task is completed** (Planner). *When a new task is created*
