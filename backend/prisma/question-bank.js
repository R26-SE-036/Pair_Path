...
exports.QUESTIONS = exports.TOPICS = exports.PLATFORM_CONCEPT_TAGS = void 0;
exports.PLATFORM_CONCEPT_TAGS = [
    'loop_boundaries',
    'conditional_logic',
    'array_indexing',
    'string_comparison',
...
exports.QUESTIONS = [
    {
        ...
        description: 'Add up every number in the array and print the total. Work out together what the ' +
    ...
    },
    {
        ...
        topicId: 'loops-topic',
        title: 'Countdown',
        description: 'Print the numbers from 10 down to 1, one per line. Decide together which direction ' +
    ...
    },
    {
        ...
        description: 'Print the average of only the positive numbers in the array. Watch what the counter ' +
    ...
    },
    {
        ...
        description: 'Starting from 64, print the value and halve it until it reaches 1. Use a while loop, ' +
    ...
    },
    {
        ...
        description: 'Print the first and the last element of the array, without hard-coding either ' +
    ...
    },
    {
        ...
        description: 'Print the array backwards, from the last element to the first. Both ends of the ' +
    ...
    },
    {
        ...
        description: 'Print the index of the first occurrence of the target, or -1 if it is not there. ' +
    ...
    },
    {
        ...
        description: 'Print a grade for the score: A for 80 and above, B for 70-79, C for 50-69, F below 50. ' +
    ...
    },
    {
        ...
        topicId: 'conditions-topic',
        title: 'In Range',
        description: 'Print whether the value falls between 10 and 20 inclusive. Read your condition ' +
    ...
    },
    {
        ...
        description: 'Return "negative", "zero" or "positive" for the given number. Every path through ' +
    ...
    },
    {
        ...
        topicId: 'conditions-topic',
        title: 'Day Type',
        description: 'Use a switch on the day name to print "weekend" or "weekday". Check what happens ' +
    ...
    },
    {
        ...
        description: 'Print whether the two answers match. They are equal as text — make sure your ' +
            'comparison says so.',
        difficulty: 'BEGINNER',
    ...
    },
    {
        ...
        description: 'Strip the surrounding spaces from the input and print it in upper case. String ' +
    ...
    },
    {
        ...
        description: 'Swap the contents of the two variables and print them. You will need somewhere to ' +
    ...
    },
    {
        ...
        description: 'Divide the total between the given number of people and print the share. Consider ' +
    ...
    },
    {
        ...
        description: 'Print a warning only when the value is above 100. Read the if statement carefully ' +
