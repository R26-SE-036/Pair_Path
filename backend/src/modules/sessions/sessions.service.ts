...
export class SessionsService {
  ...
  async getAllAnalytics() {
    // Sessions the model has actually said something about. A session with no
    // predictions has nothing to show on a timeline, and listing it would send
    // whoever clicked it to an empty page.
    return this.prisma.pairSession.findMany({
      where: {
        predictions: {
          some: {}
